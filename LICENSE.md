...
Testo completo: https://creativecommons.org/licenses/by-sa/4.0/deed.it

## Cosa vuol dire

**Puoi:**

- **condividere** il gioco, cioè copiarlo e distribuirlo con qualsiasi mezzo;
- **modificarlo**, per esempio aggiungere pianeti, tradurlo o adattarlo alla tua classe, anche per usi commerciali.
...
| Componente | Licenza |
|---|---|
| [Skulpt](https://skulpt.org), l'interprete Python | MIT |
| Caratteri Lilita One, Nunito e JetBrains Mono (Google Fonts) | SIL Open Font License 1.1 |
